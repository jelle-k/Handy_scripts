	...
	<xsl:template match="/">
		...
		<tns:Pip3A4PurchaseOrderRequest>
					...
					<tns:PartnerDescription>
						<tns:BusinessDescription>
							<tns:GlobalBusinessIdentifier>
								<xsl:value-of select='BOM/BO/AddressExtension/row/ShipToGlobalLocationNumber' />
							</tns:GlobalBusinessIdentifier>
			...
			<tns:PurchaseOrder>
				...
				<tns:remarks>
					<tns:remark context="Sales Remark" lang="EN">
				...
				<xsl:for-each select="/BOM/BO/Document_Lines/row">
					<tns:ProductLineItem>				
						<tns:remarks>
							<tns:remark context="Linereference">
				...
				<tns:shipTo>
					<tns:PartnerDescription>
						<tns:BusinessDescription>
							<tns:businessName>
								<tns:FreeFormText lang="EN">
									<xsl:value-of select='BOM/BO/Documents/row/se_CardName' />
								</tns:FreeFormText>
							</tns:businessName>
						</tns:BusinessDescription>
						<tns:GlobalPartnerClassificationCode>Buyer</tns:GlobalPartnerClassificationCode>
					...
					<tns:PhysicalAddress>
						<tns:addressLine1>
							<tns:FreeFormText lang="EN">
								<xsl:value-of select='BOM/BO/AddressExtension/row/ShipToStreet' />
							</tns:FreeFormText>
						</tns:addressLine1>
						<tns:addressLine2>
							<tns:FreeFormText lang="EN">
								<xsl:value-of select='BOM/BO/AddressExtension/row/ShipToBlock' />
							</tns:FreeFormText>
						</tns:addressLine2>
						<tns:cityName>
							<tns:FreeFormText lang="EN">
								<xsl:value-of select='BOM/BO/AddressExtension/row/ShipToCity' />
							</tns:FreeFormText>
						</tns:cityName>
						<tns:GlobalCountryCode>
							<xsl:value-of select='BOM/BO/AddressExtension/row/ShipToCountry' />
						</tns:GlobalCountryCode>
						<tns:NationalPostalCode>
							<xsl:value-of select='BOM/BO/AddressExtension/row/ShipToZipCode' />
						</tns:NationalPostalCode>
					</tns:PhysicalAddress>
				</tns:shipTo>
			</tns:PurchaseOrder>
